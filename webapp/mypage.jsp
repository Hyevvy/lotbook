		...
		<div class="container">
			...
			<div class="checkout__form">
				...
				<div class="card mb-3 border-0">
					...
					<button type="submit" class="site-btn mx-1 rounded-sm">주문
						취소</button>
				</div>
				<div class="card mb-3 border-0">
				...
				<div class="card mb-3 border-0">
					...
					<div class="row mx-1">
						<button type="submit"
							class="py-2 col-sm-6 bg-dark text-white rounded-sm">환불
							요청</button>
						<button type="submit"
							class="py-2 col-sm-6 my-button-secondary rounded-sm">주문
							확정</button>
					</div>
				...
				<div class="card mb-3 border-0">
					...
					<button type="submit" class="site-btn mx-1 rounded-sm">리뷰
						작성하기</button>
				</div>
			</div>
		</div>
